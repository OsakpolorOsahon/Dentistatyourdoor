      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="flex-shrink-0">
            <Link href="/">
              <h1 className="text-xl lg:text-2xl font-montserrat font-bold text-medical-blue cursor-pointer">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/booking">
              <Button className="bg-medical-blue text-white px-4 lg:px-6 py-2 lg:py-3 rounded-lg font-montserrat font-semibold hover:bg-opacity-90 transition-all duration-200 transform hover:scale-105">
                Book Now
              </Button>
            </Link>
